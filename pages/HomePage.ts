...
export class HomePage extends LandingPage {
  ...
  override async findPPVContainer(eventData: Record<string, string>, source?: string): Promise<any> {
    ...
    throw new Error(
      ...
      `No fallback search will be attempted. Valid sources: home-page-banner, home-page-dont-miss, home-page-get-started, home-page-live-tv-rail, home-page-dazntile, home-biggest-fights.`
    );
  }
